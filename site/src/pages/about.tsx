        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-x-16 gap-y-12">
          ...
          <div className="col-span-3 bg-black bg-opacity-80 text-green-400 font-mono rounded-3xl p-12 space-y-6">
            ...
            <p>
              ...
              you&apos;re welcome to use in your dApp. Addresses are
              automatically normalized to lowercase (via a redirect) and results
              are cached for 24 hours at Cloudflare&apos;s edge nodes, so
              responses are fast!
            </p>
